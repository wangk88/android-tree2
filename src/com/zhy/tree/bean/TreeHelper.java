...
public class TreeHelper {
	...
	private static  boolean is_target = false;
	 ...
	 * @return
	 */
	public static List<Node> filterVisibleNode(List<Node> nodes,boolean isTarget) {
		List<Node> result = new ArrayList<Node>();
	...
	private static void setNodeIcon(Node node) {
		if (is_target) {
			node.setIcon(R.drawable.shuoshi);
	...
	public static void setTarget(boolean isTarget) {
		is_target = isTarget;
	}
